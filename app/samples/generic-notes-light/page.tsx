...
import { ArrowLeft, CheckCircle2, AlertCircle, Calendar, Clock, User, Moon } from "lucide-react"

export default function GenericNotesLightPage() {
  return (
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mb-12 rounded-2xl border border-gray-200 bg-gradient-to-br from-purple-50 to-blue-50 p-8">
          <div className="mb-6 flex items-center gap-3">
            <Badge className="bg-purple-600 text-white">Generic Notes</Badge>
        ...
        <div className="mt-12 text-center">
          <Link href="/#sample-notes">
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:shadow-xl">
              Back to Sample Notes
            </Button>
          </Link>
        </div>
