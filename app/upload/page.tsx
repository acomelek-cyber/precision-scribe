...
type NoteFormat = 'standard' | 'nd-enhanced' | 'dyslexia';
                        ...
                        {testType === 'act-sat' && (
                            <div>
                                ...
                                >
                                    ...
                                    <option value="nd-enhanced">ND-Enhanced (optimized for ADHD, autism)</option>
                                    <option value="dyslexia">Dyslexia-Optimized (easy-to-read format)</option>
                                </select>
                            </div>
                        )}
